  ...
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px"
      ...
      <el-form-item prop="provinceName">
        <el-input type="text" v-model="ruleForm.provinceName" auto-complete="off" placeholder="省份名称"></el-input>
      </el-form-item>
      <el-form-item prop="cityName">
        <el-input type="text" v-model="ruleForm.cityName" auto-complete="off" placeholder="城市名称"></el-input>
      </el-form-item>
      <el-form-item prop="address">
        <el-input type="text" v-model="ruleForm.address" auto-complete="off" placeholder="详细地址"></el-input>
      </el-form-item>
      <el-form-item prop="phoneNumber">
        <el-input type="number" v-model="ruleForm.phoneNumber" auto-complete="off" placeholder="电话号码"></el-input>
      </el-form-item>
      <el-form-item>
        <el-select v-model="ruleForm.permission" placeholder="权限">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        permission: [{required: true, message: '请选择权限值', trigger: 'blur'}],
        contribute: [{required: true, message: '请输入贡献值', trigger: 'blur'}],
      }
    }
  },
  // 创建完毕状态(里面是操作)
